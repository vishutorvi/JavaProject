...
public class HeadVO {
	...
	public RepoVO getRepo() {
		return repo;
	}
	public void setRepo(RepoVO repo) {
		this.repo = repo;
	}
	...
	public String toString() {
		String returnStrings = "\'"+label + "\',\'" + ref + "\',\'" + sha + "\',";
		if(user != null){
			returnStrings += user.toString();
		}else{
			returnStrings += UserVO.nullStrings();
		}
		returnStrings+= ",";
		if(repo != null){
			returnStrings += repo.toString();
		}else{
			returnStrings += RepoVO.nullStrings();
		}
		returnStrings += "," + private1 + ",\'" + html_url + "\',\'" + description + "\'," + fork + ",\'" + url
				+ "\',\'" + forks_url + "\',\'" + keys_url + "\',\'" + collaborators_url + "\',\'"
				+ teams_url + "\',\'" + hooks_url+ "\',\'" + issue_events_url + "\',\'"
				+ events_url + "\',\'" + assignees_url	+ "\',\'" + branches_url + "\',\'" + tags_url
				+ "\',\'" + blobs_url + "\',\'" + git_tags_url	+ "\',\'" + git_refs_url + "\',\'" + trees_url
				+ "\',\'" + statuses_url + "\',\'" + languages_url + "\',\'" + stargazers_url
				+ "\',\'" + contributors_url+ "\',\'" + subscribers_url
				+ "\',\'" + subscription_url + "\',\'"	+ commits_url + "\',\'" + git_commits_url
				+ "\',\'" + comments_url + "\',\'"	+ contents_url + "\',\'" + compare_url
				+ "\',\'" + merges_url + "\',\'" + downloads_url + "\',\'" + issues_url + "\',\'"
				+ pulls_url + "\',\'" + milestones_url + "\',\'" + notification_url + "\',\'"
				+ labels_url + "\',\'" + releases_url + "\',\'" + deployments_url + "\',\'"
				+ created_at + "\',\'" + pushed_at + "\',\'"+ ssh_url + "\',\'" + clone_url + "\',\'" + svn_url
				+ "\',\'" + homepage + "\'," + size + "," + stargazers_count
				+ "," + watchers_count + ",\'"+ language + "\'," + has_issues + ","
				+ has_downloads + "," + has_wiki + ","	+ has_pages + "," + forks_count + ",\'"
				+ mirror_url + "\'," + open_issues_count + "," + forks + "," + open_issues
	...
	public static String nullStrings(){
		String returnStrings = "null,null,null,";
		returnStrings += UserVO.nullStrings()+",";
		returnStrings += RepoVO.nullStrings()+",";
		returnStrings += "null,null,null,null,null,null,null,null,null,null,null,null," +
				"null,null,null,null,null,null,null,null,null,null,null,null,null," +
				"null,null,null,null,null,null,null,null,null,null,null,null," +
				"null,null,null,null,null,null,null,null,0,0,0,null,false,false,false,false,0,null,0,0,0,0,null";
		return returnStrings;
	}
}